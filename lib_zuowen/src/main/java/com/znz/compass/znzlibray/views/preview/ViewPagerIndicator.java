...
public class ViewPagerIndicator extends LinearLayout implements
		PreviewViewPager.OnPageChangeListener {
	
	private PreviewViewPager mViewPager;
	private Context mContext;
	private int normalResId = R.drawable.homepot_gry;
	private int seletedResId = R.drawable.homepot_white;
	private int margin;
	private int count = 0;
	...
	public void setViewPager(PreviewViewPager mViewPager) {
