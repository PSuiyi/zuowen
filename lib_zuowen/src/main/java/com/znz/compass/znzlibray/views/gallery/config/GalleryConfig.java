...
public class GalleryConfig {
    ...
    private IPhotoSelectCallback iHandlerCallBack;   // GalleryPick 生命周期接口
    ...
    public static class Builder implements Serializable {
        ...
        private IPhotoSelectCallback iHandlerCallBack;
        ...
        public Builder iHandlerCallBack(IPhotoSelectCallback iHandlerCallBack) {
    ...
    public IPhotoSelectCallback getIHandlerCallBack() {
