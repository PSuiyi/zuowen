...
public class PrefenceUtils {
    ...
    protected PrefenceUtils(Context context, String prefsName) {
    ...
    public Object getObject(String key) {
        try {
            ...
            byte[] base64Bytes = Base64Util.decode(stringBase64.getBytes());
    ...
    public void putObject(String key, Object obj) {
        ...
        try {
            ...
            String stringBase64 = new String(Base64Util.decode(baos.toByteArray()));
