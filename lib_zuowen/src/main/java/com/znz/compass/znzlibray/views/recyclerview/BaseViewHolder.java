...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setText(@IdRes int viewId, @NonNull CharSequence value) {
        ...
        if (value != null) {
            if (!StringUtil.isBlank(value.toString())) {
                ...
                view.setText(mContext.getResources().getString(R.string.common_no_data));
            }
        } else {
            view.setText(mContext.getResources().getString(R.string.common_no_data));
        }
     ...
     * @return
     */
    public BaseViewHolder loadImageHeader(@IdRes int viewId, String url) {
        HttpImageView view = getView(viewId);
        view.loadHeaderImage(url);
        return this;
    }
     ...
     * @return
     */
    public BaseViewHolder loadLiveImage(@IdRes int viewId, String url) {
        HttpImageView view = getView(viewId);
        if (!StringUtil.isBlank(url)) {
            view.loadRectImage(url);
        } else {
            view.setImageResource(R.mipmap.default_live_icon);
        }
        return this;
    }
