package com.znz.compass.znzlibray.views.gallery.utils;
...
public class UCropUtils {
    ...
    public static void start(Activity mActivity, File sourceFile, File destinationFile, float aspectRatioX, float aspectRatioY, int maxWidth, int maxHeight) {
        ...
        options.setToolbarColor(mActivity.getResources().getColor(R.color.blue));
        options.setStatusBarColor(mActivity.getResources().getColor(R.color.blue));
