...
public abstract class BaseMvpListActivity<M extends IModel, T extends BaseZnzBean> extends BaseZnzActivity implements PullRecycler.OnRecyclerRefreshListener {
    ...
    protected void initializeRefreshView() {
        //刷新控件初始化
        rvRefresh = ViewHolder.init(activity, R.id.rvRefresh);
