...
//        startCalendar.set(Calendar.MINUTE, 0);
        ...
        startCalendar.set(Calendar.MINUTE, startCalendar.get(Calendar.MINUTE) + 1);
    ...
    private void loadComponent() {
        ...
        if (isDefaultNow) {
            ...
            selectedCalender.set(Calendar.YEAR, Integer.parseInt(fomatTimeUnit(now.get(Calendar.YEAR))));

            month_pv.setSelected(fomatTimeUnit(now.get(Calendar.MONTH) + 1));
            selectedCalender.set(Calendar.MONTH, Integer.parseInt(fomatTimeUnit(now.get(Calendar.MONTH))));

            day_pv.setSelected(fomatTimeUnit(now.get(Calendar.DAY_OF_MONTH)));
            selectedCalender.set(Calendar.DAY_OF_MONTH, Integer.parseInt(fomatTimeUnit(now.get(Calendar.DAY_OF_MONTH))));

            hour_pv.setSelected(fomatTimeUnit(now.get(Calendar.HOUR_OF_DAY)));
            selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(fomatTimeUnit(now.get(Calendar.HOUR_OF_DAY))));

            minute_pv.setSelected(fomatTimeUnit(now.get(Calendar.MINUTE)));
            selectedCalender.set(Calendar.MINUTE, Integer.parseInt(fomatTimeUnit(now.get(Calendar.MINUTE))));
        } else {
