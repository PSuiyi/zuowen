 ...
 */
public class CoordinatorLayoutWithLoading extends CoordinatorLayout {
    ...
    public CoordinatorLayoutWithLoading(Context context) {
        super(context);
    }

    public CoordinatorLayoutWithLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CoordinatorLayoutWithLoading(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CoordinatorLayoutWithLoading);

        //Loading state attrs
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_loadingProgressBarWidth, 250);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_loadingProgressBarHeight, 250);

        loadingStateBackgroundColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_loadingBackgroundColor, Color.TRANSPARENT);

        //Empty state attrs
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_emptyImageWidth, 308);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_emptyImageHeight, 308);

        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_emptyTitleTextSize, 15);

        emptyStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_emptyContentTextSize, 14);

        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_emptyTitleTextColor, Color.BLACK);

        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_emptyContentTextColor, Color.BLACK);

        emptyStateBackgroundColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_emptyBackgroundColor, Color.TRANSPARENT);

        //Error state attrs
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_errorImageWidth, 308);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_errorImageHeight, 308);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_errorTitleTextSize, 15);

        errorStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.CoordinatorLayoutWithLoading_errorContentTextSize, 14);

        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_errorTitleTextColor, Color.BLACK);

        errorStateContentTextColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_errorContentTextColor, Color.BLACK);

        errorStateButtonTextColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_errorButtonTextColor, Color.BLACK);

        errorStateBackgroundColor =
                typedArray.getColor(R.styleable.CoordinatorLayoutWithLoading_errorBackgroundColor, Color.TRANSPARENT);
