package com.znz.compass.znzlibray.views.advs;
 ...
 */
@SuppressLint("NewApi")
public class CycleViewPager extends android.support.v4.app.Fragment implements ViewPager.OnPageChangeListener {
    ...
    private List<AdvInfoBean> infos;
    ...
    public void setData(List<ImageView> views, List<AdvInfoBean> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<AdvInfoBean> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public void setIndicatorCenter() {
        ...
        params.setMargins(0, DipUtil.dipToPixels(3), DipUtil.dipToPixels(5), 0);
    ...
    private void setIndicator(int selectedPosition) {
        ...
        if (indicators.length > selectedPosition)
            indicators[selectedPosition].setBackgroundResource(R.drawable.dot);
    }
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(AdvInfoBean info, int postion, View imageView);
    }
}