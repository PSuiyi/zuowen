...
//            e.printStackTrace();
    ...
    public void setEmptyView(int layoutResId, ViewGroup viewGroup, String noDataDes) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(layoutResId, viewGroup, false);
    ...
    public void setEmptyView(int layoutResId, String noDataDes) {
        checkNotNull();
        setEmptyView(layoutResId, getRecyclerView(), noDataDes);
    }
