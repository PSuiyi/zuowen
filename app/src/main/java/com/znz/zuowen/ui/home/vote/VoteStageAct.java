...
public class VoteStageAct extends BaseAppActivity {
    ...
    protected void initializeView() {
        ...
        fragmentList.add(new VoteStageListFragment().newInstance("小学组"));
        fragmentList.add(new VoteStageListFragment().newInstance("初中组"));
        fragmentList.add(new VoteStageListFragment().newInstance("高中组"));
